				...
				>
					...
					>
						...
						<p className="my-5 text-sm">
							We provide world class fitness equpment, traineers and classes to get you to your ultimate fitness goals with ease. We provide true care into each and every member.
						</p>
					</motion.div>
